...
- **社内勉強会でのLT登壇(2025年6月〜2025年7月)**
  - Flutterアプリチームのリーダーとして、タスクマネジメントを担当
  - リリースに向けたスケジュール管理やチーム外の関係者との調整を担当

- **認証基盤チームの立ち上げ兼リーダー業(2025年7月〜現在)**
  - 既存認証基盤の抱える問題点を解決するため、認証基盤チームを立ち上げ
  - チームメンバーのタスク管理、進捗管理、技術的なサポートを担当
  - 現在はPoCを進めており、将来的に認証基盤の改善を目指す

- **社内向けにAI技術の導入を推進/整備を行う(2025年7月〜現在)**
  - 社内でのAI技術の活用を推進するため、情報収集や技術検証を担当
  - 社内向けにAI技術の導入ガイドラインを作成し、前者向けに共有
  - MCPハンズオン、Vibe Cordingワークショップなどの社内イベントを企画/運営/登壇
